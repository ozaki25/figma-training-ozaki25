...
真ん中の `get_design_context` は、Figma MCPが提供するツールです。フレームの構造・オートレイアウトの設定・スタイル・レイヤー名を一度にまとめて取得します。Claude Codeはこの中身を読み、指示に沿ってコードを組み立てます。ここで受け渡される情報の質は、Figma側のレイヤー名と構造の整い具合でほぼ決まります。
