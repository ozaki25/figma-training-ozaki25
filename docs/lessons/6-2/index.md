...
このレッスンで実感してほしいのは、コード生成は魔法ではないという一点です。レイヤー名が良ければコンポーネント名やクラス名がそのまま良くなり、Auto Layoutが整っていればflexやgapの構造が正確に出ます。逆に整っていないと、その分だけ手戻りが増えます。3〜4章で命名やAuto Layoutにこだわった意味が、ここで一気に返ってきます。
