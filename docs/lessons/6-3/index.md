...
6-2ではタスク一覧をコードに変換しました。ここでは2画面目、5章で作った `task-form` を同じ流れでコードにします。
...
- src/App.tsx で、6-2で作った TaskList の下に並べて表示してください
```
...
6章でデザインからコードへの変換までひととおり体験しました。4章で作ったタスク一覧と5章で作ったタスク登録フォームが、両方ともコードとして手元にあります。最後の7章で、2日間全体をふりかえります。
