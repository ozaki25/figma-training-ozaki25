...
const chapters: Chapter[] = [
  ...
  },
  {
    ...
    lessons: [
      { slug: '5-1', text: 'フォームのレイアウトを組む', link: '/lessons/5-1/' },
      { slug: '5-2', text: '入力欄・ボタンを作る', link: '/lessons/5-2/' },
      { slug: '5-3', text: '仕上げ・一貫性チェック', link: '/lessons/5-3/' },
    ],
  },
  {
    number: 6,
    text: 'Figma MCP + Claude Codeでコード化',
    lessons: [
      { slug: '6-1', text: 'Figma MCPサーバーをセットアップする', link: '/lessons/6-1/' },
      { slug: '6-2', text: 'タスク一覧画面をコード生成する', link: '/lessons/6-2/' },
      { slug: '6-3', text: 'タスク登録フォームをコード生成する', link: '/lessons/6-3/' },
    ],
  },
  {
    number: 7,
    text: 'まとめ・ふりかえり',
    lessons: [
      { slug: '7-1', text: '2日間のふりかえり', link: '/lessons/7-1/' },
    ],
  },
]
