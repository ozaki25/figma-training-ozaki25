      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '3-4 バリアブルでデザイントークンを管理する', link: '/lessons/3-4/' },
          ],
        },
        {
          ...
          items: [
            ...
            { text: '4-4 統計・フィルタ・ナビの部品を作る', link: '/lessons/4-4/' },
            { text: '4-5 一覧画面を仕上げて完成させる', link: '/lessons/4-5/' },
          ],
        },
        {
          text: '5章 Figma MCP + Claude Codeで一覧画面をコード化',
          collapsed: false,
          items: [
            { text: '5-1 Figma MCPサーバーをセットアップする', link: '/lessons/5-1/' },
            { text: '5-2 タスク一覧画面をコード生成する', link: '/lessons/5-2/' },
          ],
        },
        {
          text: '6章 実践: タスク登録フォームを作る',
          collapsed: false,
          items: [
            { text: '6-1 フォームのレイアウトを組む', link: '/lessons/6-1/' },
            { text: '6-2 入力欄・ボタンを作る', link: '/lessons/6-2/' },
            { text: '6-3 仕上げ・一貫性チェック', link: '/lessons/6-3/' },
          ],
        },
        {
          text: '7章 タスク登録フォームをコード化',
          collapsed: false,
          items: [
        ...
        },
        {
          ...
          items: [
            ...
            { text: '追加課題3 エージェントに共通コンポーネントを整備させる', link: '/extra/agent-components/' },
          ],
        },
      ],
      outline: {
